...
[![Release](https://badge.fury.io/js/%40mattndr%2Fprisma-generator-nestjs-dto.svg)](https://www.npmjs.com/package/@mattndr/prisma-generator-nestjs-dto)
[![License](https://img.shields.io/github/license/mattndr/prisma-generator-nestjs-dto.svg?label=license)](#license)
...
This is a fork of [@Brakebein/prisma-generator-nestjs-dto](https://github.com/Brakebein/prisma-generator-nestjs-dto) and currently support the following features:
...
```sh
npm install --save-dev @mattndr/prisma-generator-nestjs-dto
```
...
| `@DtoTypeFullUpdate`                | in the generated `UpdateDTO`, use the `CreateDTO` of the composite type to enforce a complete replacement the old values (see [#2](https://github.com/mattndr/prisma-generator-nestjs-dto/issues/2#issuecomment-1238855460))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
All files are released under the [Apache License 2.0](https://github.com/mattndr/prisma-generator-nestjs-dto/blob/master/LICENSE).
